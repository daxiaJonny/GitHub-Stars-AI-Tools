...
ensure_rust() {
  command -v cargo >/dev/null 2>&1 || die "Rust Cargo is not available. Install Rust before running the Tauri desktop app."
}
...
info "Starting Tauri desktop app in development mode"
exec pnpm tauri dev
