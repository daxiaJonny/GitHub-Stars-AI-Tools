...
assert.match(repositoriesPage, /<h2 className="min-w-0 flex-1 truncate font-headline-lg text-headline-lg font-bold tracking-tight text-on-surface">/, '仓库详情标题必须允许长仓库名在 flex 行内收缩，避免挤压右侧徽标');
